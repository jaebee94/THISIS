    ...
    <div class="search wrap">
        ...
        <div id="search-main">
             <div class="search" v-for="user in this.people"  v-bind:key="user.nickname">
                 <div class="search-item" v-if="user.nickname.includes(carName) || user.username.includes(carName) || user.introduction.includes(carName)" @click="goProfile(user.user_id)">
...
export default {
    ...
    ,methods: {
        ...
        getSearchList(keyword){
            ...
            axios.get('http://i3a301.p.ssafy.io:8088/THISIS/account/search', { params: {
            keyword: keyword,
